...
// TemporalRetrievalApiService TemporalRetrievalApi service
type TemporalRetrievalApiService service

type ApiQueryTemporalEntitiesRequest struct {
	ctx context.Context
	ApiService *TemporalRetrievalApiService
	link *string
	id *string
	idPattern *string
	type_ *string
...
*/
func (a *TemporalRetrievalApiService) QueryTemporalEntities(ctx context.Context) ApiQueryTemporalEntitiesRequest {
	return ApiQueryTemporalEntitiesRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *TemporalRetrievalApiService) QueryTemporalEntitiesExecute(r ApiQueryTemporalEntitiesRequest) ([]EntityTemporal, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "TemporalRetrievalApiService.QueryTemporalEntities")
	if err != nil {
...
*/
func (a *TemporalRetrievalApiService) QueryTemporalEntitiesOnPost(ctx context.Context) ApiQueryTemporalEntitiesOnPostRequest {
	return ApiQueryTemporalEntitiesOnPostRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return []EntityTemporal
func (a *TemporalRetrievalApiService) QueryTemporalEntitiesOnPostExecute(r ApiQueryTemporalEntitiesOnPostRequest) ([]EntityTemporal, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "TemporalRetrievalApiService.QueryTemporalEntitiesOnPost")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
*/
func (a *TemporalRetrievalApiService) RetrieveEntityTemporalById(ctx context.Context, entityId string) ApiRetrieveEntityTemporalByIdRequest {
	return ApiRetrieveEntityTemporalByIdRequest{
		ApiService: a,
		ctx: ctx,
		entityId: entityId,
...
// Execute executes the request
//  @return EntityTemporal
func (a *TemporalRetrievalApiService) RetrieveEntityTemporalByIdExecute(r ApiRetrieveEntityTemporalByIdRequest) (*EntityTemporal, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "TemporalRetrievalApiService.RetrieveEntityTemporalById")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
