...
// ContextInformationApiService ContextInformationApi service
type ContextInformationApiService service

type ApiAppendEntityAttrsRequest struct {
	ctx context.Context
	ApiService *ContextInformationApiService
	nGSILDTenant *string
	entityId string
...
*/
func (a *ContextInformationApiService) AppendEntityAttrs(ctx context.Context, entityId string) ApiAppendEntityAttrsRequest {
	return ApiAppendEntityAttrsRequest{
		ApiService: a,
		ctx: ctx,
		entityId: entityId,
...
func (a *ContextInformationApiService) AppendEntityAttrsExecute(r ApiAppendEntityAttrsRequest) (*http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ContextInformationApiService.AppendEntityAttrs")
	if err != nil {
...
*/
func (a *ContextInformationApiService) CreateEntity(ctx context.Context) ApiCreateEntityRequest {
	return ApiCreateEntityRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
func (a *ContextInformationApiService) CreateEntityExecute(r ApiCreateEntityRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ContextInformationApiService.CreateEntity")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}
...
*/
func (a *ContextInformationApiService) PartialAttrUpdate(ctx context.Context, entityId string, attrId string) ApiPartialAttrUpdateRequest {
	return ApiPartialAttrUpdateRequest{
		ApiService: a,
		ctx: ctx,
		entityId: entityId,
...
// Execute executes the request
func (a *ContextInformationApiService) PartialAttrUpdateExecute(r ApiPartialAttrUpdateRequest) (*http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ContextInformationApiService.PartialAttrUpdate")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}
...
*/
func (a *ContextInformationApiService) QueryEntities(ctx context.Context) ApiQueryEntitiesRequest {
	return ApiQueryEntitiesRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return []Entity
func (a *ContextInformationApiService) QueryEntitiesExecute(r ApiQueryEntitiesRequest) ([]Entity, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ContextInformationApiService.QueryEntities")
	if err != nil {
...
*/
func (a *ContextInformationApiService) RemoveEntityAttr(ctx context.Context, entityId string, attrId string) ApiRemoveEntityAttrRequest {
	return ApiRemoveEntityAttrRequest{
		ApiService: a,
		ctx: ctx,
		entityId: entityId,
...
// Execute executes the request
func (a *ContextInformationApiService) RemoveEntityAttrExecute(r ApiRemoveEntityAttrRequest) (*http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ContextInformationApiService.RemoveEntityAttr")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}
...
*/
func (a *ContextInformationApiService) RemoveEntityById(ctx context.Context, entityId string) ApiRemoveEntityByIdRequest {
	return ApiRemoveEntityByIdRequest{
		ApiService: a,
		ctx: ctx,
		entityId: entityId,
...
// Execute executes the request
func (a *ContextInformationApiService) RemoveEntityByIdExecute(r ApiRemoveEntityByIdRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodDelete
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ContextInformationApiService.RemoveEntityById")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}
...
*/
func (a *ContextInformationApiService) RetrieveEntityById(ctx context.Context, entityId string) ApiRetrieveEntityByIdRequest {
	return ApiRetrieveEntityByIdRequest{
		ApiService: a,
		ctx: ctx,
		entityId: entityId,
...
// Execute executes the request
//  @return Entity
func (a *ContextInformationApiService) RetrieveEntityByIdExecute(r ApiRetrieveEntityByIdRequest) (*Entity, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ContextInformationApiService.RetrieveEntityById")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
*/
func (a *ContextInformationApiService) UpdateEntityAttrs(ctx context.Context, entityId string) ApiUpdateEntityAttrsRequest {
	return ApiUpdateEntityAttrsRequest{
		ApiService: a,
		ctx: ctx,
		entityId: entityId,
...
// Execute executes the request
func (a *ContextInformationApiService) UpdateEntityAttrsExecute(r ApiUpdateEntityAttrsRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPatch
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ContextInformationApiService.UpdateEntityAttrs")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}
