...
func (a *SubscriptionsApiService) CreateSubscriptionExecute(r ApiCreateSubscriptionRequest) (*http.Response, error) {
	var (
...
*/
func (a *SubscriptionsApiService) RemoveSubscription(ctx context.Context, subscriptionId string) ApiRemoveSubscriptionRequest {
	return ApiRemoveSubscriptionRequest{
		ApiService: a,
		ctx: ctx,
...
// Execute executes the request
func (a *SubscriptionsApiService) RemoveSubscriptionExecute(r ApiRemoveSubscriptionRequest) (*http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SubscriptionsApiService.RemoveSubscription")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}
...
*/
func (a *SubscriptionsApiService) RetrieveSubscriptionById(ctx context.Context, subscriptionId string) ApiRetrieveSubscriptionByIdRequest {
	return ApiRetrieveSubscriptionByIdRequest{
		ApiService: a,
		ctx: ctx,
		subscriptionId: subscriptionId,
...
// Execute executes the request
//  @return Subscription
func (a *SubscriptionsApiService) RetrieveSubscriptionByIdExecute(r ApiRetrieveSubscriptionByIdRequest) (*Subscription, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SubscriptionsApiService.RetrieveSubscriptionById")
	if err != nil {
...
*/
func (a *SubscriptionsApiService) RetrieveSubscriptions(ctx context.Context) ApiRetrieveSubscriptionsRequest {
	return ApiRetrieveSubscriptionsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return []Subscription
func (a *SubscriptionsApiService) RetrieveSubscriptionsExecute(r ApiRetrieveSubscriptionsRequest) ([]Subscription, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SubscriptionsApiService.RetrieveSubscriptions")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
// Execute executes the request
func (a *SubscriptionsApiService) UpdateSubscriptionExecute(r ApiUpdateSubscriptionRequest) (*http.Response, error) {
	var (
